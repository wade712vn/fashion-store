...
{
    /// <summary>
    /// A class that finds types needed by Fs by looping assemblies in the 
    ...
    public class AppDomainTypeFinder : ITypeFinder
    {
        ...
        /// <summary>Gets or sets wether Fs should iterate assemblies in the app domain when loading Fs types. Loading patterns are applied when loading these assemblies.</summary>
        ...
        /// <remarks>If you change this so that Fs assemblies arn't investigated (e.g. by not including something like "^Fs|..." you may break core functionality.</remarks>
        ...
        /// </param>
        /// <returns>
        /// True if the assembly should be loaded into Fs.
        /// </returns>
